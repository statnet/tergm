...
\end{Sinput}
\begin{Soutput}
[1] "samp"    "samplk1" "samplk2" "samplk3"
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
[1] "flobusiness"  "flomarriage"  "samp"        
[4] "samplk1"      "samplk2"      "samplk3"     
[7] "stergm.fit.3"
\end{Soutput}
\begin{Sinput}
> flobusiness
...
edges          -6.6484     1.2301     NA < 1e-04 ***
gwesp.fixed.0   2.4243     0.8876     NA 0.00728 ** 
---
...
Convergence test P-value: 4.3e-275 
The log-likelihood improved by 0.06965 
Iteration 2 of at most 20: 
Convergence test P-value: 2.2e-45 
The log-likelihood improved by 0.01671 
Iteration 3 of at most 20: 
Convergence test P-value: 2.9e-09 
The log-likelihood improved by 0.003245 
Iteration 4 of at most 20: 
Convergence test P-value: 3.6e-03 
The log-likelihood improved by 0.0008916 
Iteration 5 of at most 20: 
Convergence test P-value: 5e-01 
Convergence detected. Stopping.
The log-likelihood improved by 0.0001261 
...
Monte Carlo MLE Results:
              Estimate Std. Error MCMC % p-value    
edges          -3.3671     0.6124      0 < 1e-04 ***
gwesp.fixed.0   1.5670     0.5816      0 0.00808 ** 
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 

     Null Deviance:   0.00  on 120  degrees of freedom
 Residual Deviance: -87.96  on 118  degrees of freedom
 
AIC: -83.96    BIC: -78.38    (Smaller is better.) 
\end{Soutput}
\begin{Sinput}
...
Equilibrium Generalized Method of Moments Results:
               Estimate Std. Error MCMC % p-value    
edges           -9.9390     0.5113     NA < 1e-04 ***
nodematch.race   2.2812     0.1605     NA < 1e-04 ***
degree0         -0.1963     0.3842     NA 0.60929    
concurrent      -0.8274     0.2966     NA 0.00527 ** 
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
...
\begin{Soutput}
       ...
       221.718        183.297        181.943         87.190 
\end{Soutput}
\begin{Sinput}
> msm.target.stats
\end{Sinput}
