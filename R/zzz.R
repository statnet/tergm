...
.RegisterProposals <- function(){
  ...
  ergm_proposal_table("t", "Bernoulli", "&discord&TNT",  0, "discordStratTNT", "discordStratTNT")
  ergm_proposal_table("t", "Bernoulli", "&discord&TNT",  0, "discordBDTNT", "discordBDTNT")
  ergm_proposal_table("t", "Bernoulli", "&discord&TNT",  0, "discordBDStratTNT", "discordBDStratTNT")
}
